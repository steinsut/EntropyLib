...
public abstract class DynLivingEntity<S extends DynEntityRenderState<S>> extends LivingEntity implements IDynEntity<S> {
    protected final DynEntityHelper<S> helper;

    public DynLivingEntity(EntityType<? extends LivingEntity> type, Level level, EntityDynRendererType<?, ?, S> dynRendererType, DynEntitySyncPolicy dynSyncPolicy) {
        super(type, level);
