...
public class DynEntitySyncPolicy {
    public static Codec<DynEntitySyncPolicy> CODEC = DYN_ENTITY_SYNC_POLICY_REGISTRY.byNameCodec();

    private final Supplier<IEntityDynSyncHandler> handlerSupplier;

    public DynEntitySyncPolicy(Supplier<IEntityDynSyncHandler> handlerSupplier) {
